...
/// @dev Prefix used to create a marking of the bytecodeHash as known
bytes32 constant KNOWN_CODE_STORAGE_EMPTY_STRING_KECCAK = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470;

/// @dev Marker that is used to indicate that the contract has been constructed
bytes32 constant CONSTRUCTED_MARKER = bytes32(uint256(1));
