...
export default function Page() {
  return (
    <div className="min-h-screen min-w-[70vw] bg-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[15vh] bg-gradient-to-t from-white/90 via-white/50 to-transparent pointer-events-none"></div>
      ...
      <div className="relative z-10 min-w-[70vw] container mx-auto px-4 py-8 min-h-screen flex flex-col items-center justify-between">
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative w-full  mx-auto">
          ...
          <div className="absolute w-[120px] h-[120px] left-[20%] top-[30%] rotate-1 transition-transform duration-300 hover:scale-105 hover:-rotate-1">
            <img
          ...
          <div className="absolute w-[120px] h-[120px] right-[20%] bottom-[30%] -rotate-1 transition-transform duration-300 hover:scale-105 hover:rotate-1">
            <img
          ...
          <div className="absolute w-[150px] h-[150px] right-[5%] bottom-[10%] -rotate-3 transition-transform duration-300 hover:scale-105 hover:rotate-3">
            <img
